...
def verify_login():
    ...
    if username.get() == "user" and password.get() == "pass":
        ...
        #checks for any hidden message is attcahed to image
        def checkmsg():
            message = lsb.reveal(filename)

            # Print the extracted message
            text.delete('1.0', END)
            text.insert(END, "Hidden message: " + message + "\n")
